...
def save_melgram(filedir, database_filepath, outpath):
    ...
    for file in os.listdir(filedir):
        if(file.endswith(".mp3")):
            ...
            melspectogram = librosa.feature.melspectrogram(y=x, sr=sr, n_mels=96, n_fft=2048, hop_length=512, window=signal.windows.kaiser(M=2048, beta=6))
...
if __name__=="__main__":
    outpath = "../database/melgrams/melgrams_2048_nfft_512_hop_kaiser/"
