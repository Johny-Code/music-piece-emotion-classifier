...
class InceptionDepthwise(Model):
    def __init__(self):
        super().__init__()
        ...
        self.depth_conv1 = DepthwiseConv2D(kernel_size=(3, 3), padding='same', strides=(1, 1), activation='relu')

        self.conv4 = Conv2D(filters=32, kernel_size=(1, 1), padding='same', strides=(1, 1), activation='relu')
        self.batch_norm2 = BatchNormalization()
        self.depth_conv2 = DepthwiseConv2D(kernel_size=(3, 3), padding='same', strides=(1, 1), activation='relu')
        self.batch_norm3 = BatchNormalization()
        self.depth_conv3 = DepthwiseConv2D(kernel_size=(3, 3), padding='same', strides=(1, 1), activation='relu')

        self.conv5 = Conv2D(filters=32, kernel_size=(1, 1), padding='same', strides=(1, 1), activation='relu')
        self.batch_norm4 = BatchNormalization()
        self.depth_conv4 = DepthwiseConv2D(kernel_size=(3, 3), padding='same', strides=(1, 1), activation='relu')
        self.batch_norm5 = BatchNormalization()
        self.depth_conv5 = DepthwiseConv2D(kernel_size=(3, 3), padding='same', strides=(1, 1), activation='relu')
        self.batch_norm6 = BatchNormalization()
        self.depth_conv6 = DepthwiseConv2D(kernel_size=(3, 3), padding='same', strides=(1, 1), activation='relu')
