...
from keras.layers import Conv2D, MaxPooling2D, BatchNormalization, Add, UpSampling2D
from keras.layers import concatenate
from implementation.InceptionDepthwise import InceptionDepthwise


class InceptionResnet(Model):
    def __init__(self):
        super().__init__()
        self.max_pool1 = MaxPooling2D(pool_size=(2, 2), strides=None, padding="same")
